          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                {user.category && (
                  <span className="inline-block bg-primary-100 text-primary-800 text-sm px-3 py-1 rounded-full mt-1">
                    {user.category}
                  </span>
                )}
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {user?.role === 'artisan' && (
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">Background photo is only for artisans</p>
                    </div>
                  )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <Link to="/dashboard" className="w-full btn-outline text-left block text-center">
                  Dashboard
                </Link>
                {user?.role === 'artisan' && (
                  <Link to="/products" className="w-full btn-outline text-left block text-center">
                    My Products
                  </Link>
                )}
                <Link to="/posts" className="w-full btn-outline text-left block text-center">
                  Posts
                </Link>
                <Link to="/ai-tools" className="w-full btn-outline text-left block text-center">
                  AI Tools
                </Link>
              </div>
            </div>
