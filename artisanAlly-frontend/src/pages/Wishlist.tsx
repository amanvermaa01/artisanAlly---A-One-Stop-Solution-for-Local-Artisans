    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-dark-950 flex items-center justify-center transition-colors duration-300">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">You need to login to view your wishlist</p>
          <Link
            to="/login"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {wishlistItems.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">Discover amazing products and add them to your wishlist</p>
            <Link
              to="/products"
              className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors"
            >
