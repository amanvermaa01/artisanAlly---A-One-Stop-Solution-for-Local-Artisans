...
const PostDetail = () => {
  ...
  if (!currentPost.user || !currentPost.title || !currentPost.content) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Post data incomplete</h2>
          <p className="text-gray-600 mb-6">This post has incomplete data</p>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="font-medium text-gray-900">{currentPost.user?.name || 'Unknown User'}</h3>
